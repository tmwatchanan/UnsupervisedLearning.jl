...
# ╔═╡ e6fe1a10-1b32-11ec-3a45-91794838766d
using Plots

# ╔═╡ 6d7d316f-f3c9-40f5-aaa4-a05434708baf
X = Float64[2 5; 6 4; 5 3; 2 2; 1 4; 5 4; 3 3; 2 3; 2 4; 8 2; 9 2; 10 2; 11 2; 10 3; 9 1]

# ╔═╡ 0c9530ec-eb63-4a3f-b87f-bf0108eb032f
d2(x⃗, y⃗) = sqrt(sum((x⃗ - y⃗).^2))

# ╔═╡ 3b98b7de-6fa5-4727-b120-ba5981f9de81
N = size(X)[1]

# ╔═╡ 5a5edb1f-01fe-4faa-8747-e5064ddc802d
begin
	done = false
	prototypes = X[1:4, :]
	K = size(prototypes)[1]
	...
	for t = 1:10
		...
		cluster_assignments = map(argmax, eachrow(distances))
		...
		println("conv ", prototypes,  previous_prototypes)
	...
	println(map(argmin, eachrow(distances)))
	cluster_assignments = map(argmin, eachrow(distances))
	println("cluster @ ", cluster_assignments)
end

# ╔═╡ c5a28d82-5c0c-4a18-ba5f-3bc83c0bd8b2
prototypes

# ╔═╡ 85a545b0-e96c-4842-8efa-364d72a89ae5
done

# ╔═╡ e8455aa0-9a1e-4da8-9a8e-514da8549287
previous_prototypes
